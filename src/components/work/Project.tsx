...
export default function Project ({src,preTitle,live,code}:Props) {
  ...
  return (
    <>
      {/* image */}
      <div
        className="relative overflow-hidden w-[380px] sm:w-[470px] md:w-[660px] xl:w-[561px] h-[350px] xl:h-[316px] border-2 border-white group rounded-xl bg-cover bg-top hover:bg-bottom transition-all duration-[8s] ease-in-out hover:cursor-pointer"
